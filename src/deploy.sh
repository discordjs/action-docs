...
echo "# Initialise some useful variables"
...
echo "# Checkout the repo in the target branch so we can build docs and push to it"
TARGET_BRANCH="docs"
git clone $REPO out -b $TARGET_BRANCH

echo "# Move the generated JSON file to the newly-checked-out repo, to be committed and pushed"
...
echo "# ...then do the same once more for the webpack"
TARGET_BRANCH="webpack"
git clone $REPO out -b $TARGET_BRANCH

echo "# Move the generated webpack over"
